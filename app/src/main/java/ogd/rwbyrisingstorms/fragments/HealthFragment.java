package ogd.rwbyrisingstorms.fragments;
...
public class HealthFragment extends Fragment {
    ...
    public void update() {
        ...
        ImageView health = (ImageView) getView().findViewById(R.id.healthbar_left_first);
        Log.d("Fragment", "" + health.getLayoutParams().width);
        health.getLayoutParams().width = health.getLayoutParams().width - 10;
    }
}
